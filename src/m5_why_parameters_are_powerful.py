...
def main():
    ...
    # -------------------------------------------------------------------------
    # draw_circles(rg.Point(100, 50))point, radii, number, color, thickness
    # draw_circles(rg.Point(-200, 0))
    # better_draw_circles(rg.Point(-100,50), 27)
    # better_draw_circles(rg.Point(100, 50), 12)
    # better_draw_circles(rg.Point(0,-150), 15)
    # even_better_draw_circles(rg.Point(-200,200), 10, 6, 'red', 5)
    # even_better_draw_circles(rg.Point(200, 200), 15, 11, 'blue', 10)
    # even_better_draw_circles(rg.Point(-200, -200), 15, 11, 'blue', 10)
    # even_better_draw_circles(rg.Point(200, -200), 10, 6, 'red', 5)
    even_better_draw_circles(rg.Point(0, 0), 20, 20, 'purple', 30)
    even_better_draw_circles(rg.Point(150, 225), 10, 10, 'white', 28)
    even_better_draw_circles(rg.Point(-150, 225), 10, 10, 'white', 28)
    even_better_draw_circles(rg.Point(-150, 90), 104, 2, 'black', 5)
    even_better_draw_circles(rg.Point(150, 90), 104, 2, 'black', 5)
    even_better_draw_circles(rg.Point(-150, 180), 20, 2, 'green', 20)
    even_better_draw_circles(rg.Point(150, 180), 20, 2, 'green', 20)
    even_better_draw_circles(rg.Point(-150, 190), 10, 2, 'black', 10)
    even_better_draw_circles(rg.Point(150, 190), 10, 2, 'black', 10)
    even_better_draw_circles(rg.Point(0, -240), 100, 2, 'red', 50)
